...
class GameState:
    def __init__(self):
        ...
        self.castleRightLog = [CastleRights(
    ...
    def makeMove(self, move):
        ...
        self.castleRightLog.append(CastleRights(
    ...
    def undoMove(self):
        ...
        if len(self.moveLog) != 0:  # make sure that there is a move to undo
            ...
            self.currentCastlingRight = self.castleRightLog[
...
class Move:
    ...
    def __str__(self):
        ...
        if self.pieceMoved[1] == "p":
            if self.is_capture:
                return self.cols_to_files[self.startCol] + "x" + endSq
            else:
